	...
	ZOHO.embeddedApp.on("PageLoad", function (data) {
		...
		.then(function(data){
			...
			for(let i in data.data){
				...
				let tempRecord = {
					Sale_Volume_Last_6_months_1: recordData.Sale_Volume_Last_6_months_1, //Current Month
					Sale_Volume_Last_6_months: recordData.Sale_Volume_Last_6_months, // 3 Month
					Sale_Volume_Last_9_months_1: recordData.Sale_Volume_Last_9_months_1, // 6 Month
					Sale_Volume_Last_9_months: recordData.Sale_Volume_Last_9_months, // 9 Month
					Sale_Volume_Last_3_months_2: recordData.Sale_Volume_Last_3_months_2, // 12 Month
					Sale_Volume_Last_3_months: recordData.Sale_Volume_Last_3_months // 24 Month
				}
				arrayFilterRecord.push(tempRecord);
				
			}
			let value = [arrayFilterRecord[0].Sale_Volume_Last_6_months_1, arrayFilterRecord[0].Sale_Volume_Last_6_months, arrayFilterRecord[0].Sale_Volume_Last_9_months_1, arrayFilterRecord[0].Sale_Volume_Last_9_months, arrayFilterRecord[0].Sale_Volume_Last_3_months_2, arrayFilterRecord[0].Sale_Volume_Last_3_months]
			...
			var myChart = new Chart(ctx, {
				...
				data: {
					...
					labels: ['Sales Volume Current', 'Sales Volume 3 Months', 'Sales Volume 6 Months', 'Sales Volume 9 Months', 'Sales Volume 12 Months', 'Sales Volume 24 Months'],
					datasets: [{
						label: '# of Votes',
						data: value,
						backgroundColor: [
